...
// FINAL FIX: Using a generic component signature that satisfies strict ESBuild/TypeScript checks by explicitly avoiding implicit 'any' on props.
...
const Cpu = (props) => <Icon {...props}><rect width="16" height="16" x="4" y="4" rx="2" /><rect width="6" height="6" x="9" y="9" /><path d="M9 1v3"/><path d="M15 1v3"/><path d="M9 20v3"/><path d="M15 20v3"/><path d="M20 9h3"/><path d="M20 14h3"/><path d="M1 9h3"/><path d="M1 14h3"/></Icon>;
